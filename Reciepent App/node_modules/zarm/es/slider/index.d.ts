...
export default class Slider extends PureComponent<SliderProps, SliderStates> {
    ...
    handleDragMove: (event?: MouseEvent | TouchEvent | undefined, dragState?: DragState | undefined) => boolean;
    handleDragEnd: (_event?: MouseEvent | TouchEvent | undefined, dragState?: DragState | undefined) => void;

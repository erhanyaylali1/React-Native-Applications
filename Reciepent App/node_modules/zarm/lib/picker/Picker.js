...
var Picker = /*#__PURE__*/function (_Component) {
  ...
  function Picker() {
    ...
    _this.state = _objectSpread(_objectSpread({}, _parseProps.default.getSource(_this.props)), {}, {
      stopScroll: false
    });
    ...
    _this.onChange = function (selected) {
      ...
      var stopScroll = _this.state.stopScroll;
      var value = selected.map(function (item) {
        return item[valueMember];
      });
      var stateData = stopScroll ? {
        value: value,
        objValue: selected,
        stopScroll: false
      } : {
    ...
    _this.onOk = /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              setTimeout(function () {
                var objValue = _this.state.objValue;
  ...
  (0, _createClass2.default)(Picker, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          others = (0, _objectWithoutProperties2.default)(_this$props2, ["prefixCls", "className", "cancelText", "okText", "title", "locale", "maskClosable", "mountContainer", "destroy", "onOk", "onCancel", "visible"]);
      ...
      return /*#__PURE__*/_react.default.createElement(_popup.default, {
      ...
      }, cancelText || locale.cancelText), /*#__PURE__*/_react.default.createElement("div", {
        ...
        onClick: this.onOk
      }, okText || locale.okText)), /*#__PURE__*/_react.default.createElement(_pickerView.default, (0, _extends2.default)({}, others, {
        value: value,
    ...
    value: function getDerivedStateFromProps(props, state) {
      if (!(0, _isEqual.default)((0, _removeFnFromProps.default)(props, ['onOk', 'onCancel', 'onChange']), (0, _removeFnFromProps.default)(state.prevProps, ['onOk', 'onCancel', 'onChange']))) {
        return _objectSpread(_objectSpread({
          ...
          tempValue: _parseProps.default.getSource(props).value,
          tempObjValue: _parseProps.default.getSource(props).objValue
        });
      }
